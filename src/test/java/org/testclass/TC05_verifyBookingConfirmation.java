...
public class TC05_verifyBookingConfirmation extends BaseClass {
	...
	public static void closeBrowser() throws InterruptedException {
		if (isinBookingPage) {
			System.out.println("Test Passed:TC05_verifyBookingConfirmation");
		} else {
			System.out.println("Test Skipped:TC05_verifyBookingConfirmation");
		}
		Thread.sleep(2000);
		driver.quit();
	}
